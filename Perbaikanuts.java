...
public class Perbaikanuts {
    public static void main(String[] args) {
        ...
        input.add(new Mahasiswa("Raka", "Kalkulus", 4, 88));
        input.add(new Mahasiswa("Fara", "Bahasa Inggris", 2, 90));
        input.add(new Mahasiswa("Andre", "Statistika", 2, 84));
        input.add(new Mahasiswa("Lala", "Pemrograman", 4, 92));
        input.add(new Mahasiswa("Nizar", "Logika Infor", 3, 98));
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    for (int i = 0; i < input.size(); i++) {
                        ...
                        System.out.println((i + 1) + "\t" + mhs.namaMahasiswa + "\t" + mhs.mataKuliah + "\t" + mhs.SKS
                                + "\t" + mhs.nilai);
                        jumlahSKS += mhs.SKS;
